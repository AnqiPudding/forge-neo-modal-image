...
The Docker source stays in this private repo. The workflow uses `DOCKERHUB_USERNAME` and `DOCKERHUB_TOKEN` repository secrets, creates the public Docker Hub repository if needed, and pushes the image there.
